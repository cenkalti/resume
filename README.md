...
### [Atolio](https://atolio.com): Senior Backend Engineer, Toronto, 01/2024-...
...
[/1]: # (brew install pandoc mactex)
[/2]: # (ln -s /Library/TeX/Root/bin/universal-darwin/pdflatex /usr/local/bin/pdflatex)
[/3]: # (pandoc -V pagestyle=empty -V geometry:"top=0.5cm, bottom=0.5cm, left=1cm, right=1cm" -V urlcolor=cyan -o resume.pdf README.md)
